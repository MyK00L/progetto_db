...
CREATE OR REPLACE VIEW ComposizioneTreno AS SELECT * FROM Esercizio JOIN Convoglio ON Esercizio.IDConvoglio = Convoglio.ID JOIN Carrozza on Convoglio.IDCarrozza = Carrozza.ID;
